...
* Adds a  function to  to compute responses in t… (#442) @markbrocato
...
---
## [v2.0.2](https://github.com/moovweb/xdn/releases/tag/v2.0.2) (2020-08-14)
## What’s Changed

* Fix support for tsx pages in next.js apps. (#416) @markbrocato
* Bump lodash from 4.17.15 to 4.17.19 in /integration-tests/edge (#408) @dependabot

---
## [v2.0.1](https://github.com/moovweb/xdn/releases/tag/v2.0.1) (2020-08-13)
## What’s Changed

* Fix bug with full URLs with protocol and host in next.js redirects. (#411) @markbrocato
* Fix conversion from route to back references in edge (#410) @ierceg
